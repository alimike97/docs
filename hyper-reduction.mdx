...
Following are some of the methods available in ROMify to find S.
...
This method places the sampling points at the regions corresponding to the highest gradients of representative features, it inherently covers the rows of the basis exhibiting high gradients, leads to better con- dition numbers and more stability.

<Warning>
  The FGS method directly leverages the adaptive ROM framework, and currently it is not applicable in the static basis, static sampling methods in ROMify.
</Warning>